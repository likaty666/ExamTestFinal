...
namespace CinemaUI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(IGenericRepository<Film> repofilm, IGenericRepository<SessionDate> reposes, IGenericRepository<Hall> repohall, IGenericRepository<Ticket> repoticket)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.tickets = repoticket.GetAll();
            ViewBag.hall = repohall.GetAll();
            ViewBag.ses = reposes.GetAll();
            ViewBag.film = repofilm.GetAll();
